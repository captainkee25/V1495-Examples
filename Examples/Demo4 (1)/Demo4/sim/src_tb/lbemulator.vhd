...
ARCHITECTURE behav OF lbemulator IS
  ...
  type buffer_type   is array (0 to 16384) of std_logic_vector(31 downto 0);
	...
	type   process_type is (init, write_DELAY_FDL, write_GATE_FDL, write_DELAY_PDL, write_GATE_PDL,                          write_CTRL_REG, read_CTRL_REG);
	signal process_step : process_type;
  signal data_fifo    : buffer_type;
...
begin
  ...
  begin
    ...
    process_step	<=	write_CTRL_REG;
		lb_write32(X"1018", X"00000013");   -- set control register
    
    process_step	<=	write_DELAY_FDL;
		lb_write32(X"101C", X"00000003");   -- write DELAY_FDL value
    
    process_step	<=	write_GATE_FDL;
		lb_write32(X"1020", X"00000003");   -- write GATE_FDL value
    
    process_step	<=	write_DELAY_PDL;
		lb_write32(X"1024", X"0000000A");   -- write DELAY_PDL value
    
    process_step	<=	write_GATE_PDL;
		lb_write32(X"1028", X"00000007");   -- write GATE_PDL value
