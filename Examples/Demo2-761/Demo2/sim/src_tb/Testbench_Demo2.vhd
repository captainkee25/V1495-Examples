...
entity Testbench_Demo2 IS
end entity Testbench_Demo2;


architecture bhv of Testbench_Demo2 is

	---------------------
	------ Constants ----
	---------------------	
	constant SYS_CLK_PERIOD			: time	 	:= 25 ns;
	constant SIM_LENGTH					: integer := 450;
...
begin
	...
	instance_top_level: V1495_Demo2
	port map(
    -- Front Panel Ports
