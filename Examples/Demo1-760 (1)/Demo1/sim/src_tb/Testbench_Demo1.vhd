...
entity Testbench_Demo1 IS
end entity Testbench_Demo1;


architecture bhv of Testbench_Demo1 is

	---------------------
	------ Constants ----
	---------------------	
	constant SYS_CLK_PERIOD			: time	 	:= 20 ns;
	constant SIM_LENGTH					: integer := 200;
...
begin
	...
	instance_top_level: V1495_Demo1
	port map(
    -- Front Panel Ports
